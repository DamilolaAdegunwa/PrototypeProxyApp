...
namespace PrototypeProxyApp.Tests
{
    ...
    public class PrototypeProxyAppTestModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PrototypeProxyAppTestModule).GetAssembly());
        }
        ...
        private void SetupInMemoryDb()
        {
            ...
            IocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<PrototypeProxyAppDbContext>>()
